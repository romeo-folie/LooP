...
router.post('/:problem_id', verifyCsrfToken, authenticateJWT, validateReminderCreation, validateRequest, createReminder);
router.put('/:reminder_id', verifyCsrfToken, authenticateJWT, validateReminderUpdate, validateRequest, updateReminder);
router.delete('/:reminder_id', verifyCsrfToken, authenticateJWT, deleteReminder);
