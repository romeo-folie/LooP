...
const signInUser = async (userCredentials: SignInFormValues, apiClient: AxiosInstance) => {
...
const SigninForm: React.FC = () => {
  ...
  const mutation = useMutation<SigninResponse, AxiosError<APIErrorResponse>, SignInFormValues>({
    mutationFn: (userCredentials: SignInFormValues) => signInUser(userCredentials, apiClient),
    onSuccess: (data) => {
      if (!data.token) {
        toast({
          title: "Error",
